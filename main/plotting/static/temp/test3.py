...
file_paths = {
    'Mean': 'data/test11/mean/results_mean.csv',
    'Raw': 'data/test11/raw/results_raw.csv',
    'Median': 'data/test11/median/results_median.csv',
    'Savitzky': 'data/test11/Savitzky/results_savitzky.csv',
    'Kalman': 'data/test11/kalman/results_kalman.csv'
}
